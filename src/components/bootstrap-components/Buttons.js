  ...
  <Fragment>
    ...
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <FalconEditor
          code={IconButtonCode}
          scope={{ FontAwesomeIcon, ButtonIcon }}
        />
      </CardBody>
    </Card>
    <Card className="mb-3">
    ...
    <Card className="mb-3">
      <CardHeader>
        ...
        <p className="mb-0">
          ...
          <code>.btn-group</code>. Add on optional JavaScript radio and checkbox
          style behavior with
        </p>
      </CardHeader>
      <CardBody className="bg-light">
    ...
    <Card className="mb-3">
      <CardHeader>
        <h5>Sizing</h5>
        <p className="mb-0">
          Insteam of aplying button sizing classes to every button in a group,
          just add .btn-gorup-* to each .btn-group, including each one when
