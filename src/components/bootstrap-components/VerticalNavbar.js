    ...
    <Fragment>
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          Falcon used the reactstrap&apos;s <code>expand</code> property in{' '}
          <code>Navbar</code> component to decide when the navbar vertical will
          expand or not.
          <CodeHighlight
            language="html"
            code={`
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          ...
          state when the page loads. From your project directory,{' '}
          <code>src/context/Context.js</code> and set initial navbar collapse
          state like <code>isNavbarVerticalCollapsed: false</code> into{' '}
          <code>AppContext</code> then go to <code>src/Main.js</code> for set
          the value to the AppContext provider
          <CodeHighlight
            language="jsx"
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line
          ...
          <Media>
            ...
            <Media body>
              ...
              <p className="mb-1">
                ...
                <code>background-color</code> with Navbar Vertical vibrant.
              </p>
              <Button
                tag="a"
                href="#!"
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          Use <code>navbarStyle</code> prop to <code>NavbarVertical</code>{' '}
          component to change the navbar style. Example:
          <CodeHighlight
            language="jsx"
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          Falcon allow you to customize your Navbar vibrant with SCSS variables.
          The available options are listed below:
          <h6 className="mt-3 fs-0">Background</h6>
          <p>
            To change the background only for the Navbar vibrant, add the inline
            CSS style to <code>Collapse</code> tag in{' '}
            <code>NavbarVertical.js</code> file.
          </p>
          <CodeHighlight
            language="jsx"
            code={`<Collapse
...
>`}
          />
          <p className="my-3">
            For other navbar style add the SCSS variables{' '}
            <code>$navbar-inverted-bg, navbar-card-bg</code> in your
            <code>_user-variables.scss</code>. You can update both overlay color
            using this variable. Example:
          </p>
          <CodeHighlight
            language="scss"
...
$navbar-card-bg: $gray-1000`}
          ...
          <p>
            To change the shadow of the Navbar Card, add the SCSS variable{' '}
            <code>$navbar-card-shadow</code> in your
          ...
          <p>
            To change the color of the Navbar Vibrant links, add the SCSS
            variable <code>$navbar-vibrant-link-color</code> in your
            <code> _user-variables.scss.</code>. Example:
          </p>
          <CodeHighlight
            language="scss"
          ...
          <p>
            To change the hover color of the Navbar Vibrant links, add the SCSS
            vairable <code>$navbar-vibrant-link-hover-color</code> in your
            <code>_user-variables.scss</code>. Example:
          </p>
          <CodeHighlight
            language="scss"
          ...
          <p>
            To change the active color of the Navbar Vibrant links, add the SCSS
            vairable <code>$navbar-vibrant-link-active-color</code> in your
            <code>_user-variables.scss</code>. Example:
          </p>
          <CodeHighlight
            language="scss"
          ...
          <p>
            To change the divider color, add the SCSS vairable{' '}
            <code>$navbar-vibrant-hr-color</code> in your
            <code>_user-variables.scss</code>. Example:
          </p>
          <CodeHighlight
            language="scss"
          ...
          <p>
            To change the scrollbar color, add the SCSS vairable{' '}
            <code>$navbar-vibrant-scrollbar-color</code> in your
            <code>_user-variables.scss</code>. Example:
          </p>
          <CodeHighlight
            language="scss"
          ...
          <p className="mt-4 font-weight-bold">
            For the <code>inverted</code> and <code>card</code> variation,
