...
const NavBarTop = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <Button
          onClick={() => setIsTopNav((prevIsTopNav) => !prevIsTopNav)}
          color="link"
          size="sm"
          className="pl-0"
        >
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            ...
            components. <code>Navbar</code>, <code>NavbarToggler</code>,{' '}
            <code>NavbarBrand</code>, <code>Nav</code>, <code>NavbarText</code>,
            all of those sub-components are used in Navbar Top.
          </p>
        </CardBody>
      </Card>
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            ...
            dropdown menu display onClick by default on reactstrap. Falcon
