    ...
    <Fragment>
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            Falcon Sidepanel uses Boostrap Modal features to show the panel
            content. <code>.modal-fixed-right</code> and
            <code>.modal-dialog-vertical</code> classes are used to stick the
            panel at the right side and animate the panel from right to left.
          </p>
          <CodeHighlight
            language="html"
            code={`
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            {' '}
            You can pass options via Props through <code>Sidepanel</code>{' '}
            component. It will decide whether the panel is shown or remain
          ...
          <Table class="border border-200 fs--1" bordered responsive>
            ...
            <tbody>
              <tr>
                ...
                <td class="white-space-nowrap">
                  Set <code>true </code>to make the Slidepanel show
              ...
              <tr>
                ...
                <td class="white-space-nowrap">
                  How much time <i>(ms) </i>should wait after the page is loaded
                  before showing the Sidepanel. Works only when the autoShow is
                  set true
                </td>
              </tr>
              <tr>
                ...
                <td class="white-space-nowrap">
                  The Sidepanel will show only once - for the first time when a
                  user view the website and remain hidden as per the cookie
                  expiration date.
                </td>
              </tr>
              <tr>
