    ...
    <Fragment>
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            Falcon&apos;s Cookie Notice uses Reactstrap&apos;s &quot;Alerts&quot; feature to show
            the notice content. <code>visible</code> state is responsible for
            showing the notice as a popup. See{' '}
            <a
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            {' '}
            You can pass options via Props through <code>CookieAlert</code>{' '}
            component. It will decide whether the notice is shown or remain
          ...
          <Table className="border border-200" bordered responsive>
            ...
            <tbody>
              <tr>
                ...
                <td className="white-space-nowrap">
                  Set <code>true </code>to make the notice show automatically
              ...
              <tr>
                ...
                <td className="white-space-nowrap">
                  ...
                  before showing the notice. Works only when the autoShow is set
                  true
                </td>
              </tr>
              <tr>
                ...
                <td className="white-space-nowrap">
                  The notice will show only once - for the first time when a
